package com.justryoo.manager.config;


import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.justryoo.manager.filter.KickoutSessionFilter;
import com.justryoo.manager.listener.ShiroSessionLinstener;
import com.justryoo.manager.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager sessionManager() {
		...
		sessionManager.setGlobalSessionTimeout(120000L);
		sessionManager.setSessionValidationSchedulerEnabled(true);
		sessionManager.setSessionValidationInterval(60000L);
		sessionManager.setSessionIdUrlRewritingEnabled(false);
        Collection<SessionListener> listeners = new ArrayList<>();
        ((ArrayList<SessionListener>) listeners).add(shiroSessionLinstener());
    ...
    @Bean
    public ShiroSessionLinstener shiroSessionLinstener(){
        return new ShiroSessionLinstener();
    }
}
